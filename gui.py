...
plainlabel.grid(row=1,column=1,padx=10,pady=10)
ptEntry = tb.Entry(window, width=45, bootstyle='dark',font=(8))
ptEntry.grid(row=1,column=2,columnspan=2,padx=10,pady=10)
...
def selected(event):
    ...
    if chooseMethod.get() == 'RSA':
        ...
        keylabel.grid(row=5,column=1)
        keyEntry.grid(row=5,column=2,columnspan=2)
key1label = Label(window,text ='Key 1:',font=(8))
key2label = Label(window,text ='Key 2:',font=(8))
key1Entry = tb.Entry(window,width=45,font=(8))
key2Entry = tb.Entry(window,width = 45,font=(8))
...
def encrypt():
    ...
    try:
        if chooseMethod.get() == 'Ceasar Cipher':
            ...
            print(a)
            key1label.grid(row=8,column=1, padx=(10,0),pady=10)
            key1Entry.grid(row=8, column=3,padx=(0,150),pady=10)
            key1Entry.insert(0,key1)
            key2Entry.insert(0,key2)
            
            key2label.grid(row=9,column=1, padx=(10,0),pady=10)
            key2Entry.grid(row=9, column=3,padx=(0,150),pady=10)

            ciphertextLabel.grid(row=10,column=1,padx=(10,0),pady=10)
            cipherEntry.grid(row=10,column=3,padx=(0,150),pady=10)
            cipherEntry.insert(0,a)
